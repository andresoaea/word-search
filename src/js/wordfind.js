        ...
        return {
            ...
            newPuzzle: function(words, settings) {
                ...
                var options = {
                    ...
                    allowExtraBlanks:
                        opts.allowExtraBlanks !== undefined
                            ? opts.allowExtraBlanks
                            : true,
                    maxAttempts: opts.maxAttempts || 3,
                    maxGridGrowth:
                        opts.maxGridGrowth !== undefined
                            ? opts.maxGridGrowth
                            : 10,
                    preferOverlap:
                ...
                if (options.fillBlanks) {
                    ...
                    if (typeof options.fillBlanks === 'function') {
                        ...
                        lettersToAdd = options.fillBlanks
                            .toLowerCase()
                            .split('');
                        extraLetterGenerator = () =>
                ...
                try {
                    ...
                    for (var i = 0; i < words.length; i++) {
                        ...
                        try {
                            ...
                            console.log(
                                `Solution found without word "${words[i]}"`
                            );
                            return puzzle;
